    ...
    return (
        ...
        <div className="row h-100">
         ...
         <div className="card bg-primary w-75 text-white">
            <div className="class-header d-flex bg-primary border-0">
                <h3>Latest Task</h3>
            ...
            <div className="card-body">
                {
                    recentTask.map((item)=>{
                        return( 
                            <div key={item.id} className='d-Flex border-1 border border-warning align-center px-3 py-2'>
                                <p className='text-warning mb-0'>{item.title}</p>
                                <p className="text-warning ms-auto mb-0">{item.dueDate}</p>
                            </div>
                        )
                    })
                }
